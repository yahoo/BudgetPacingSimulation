...
max_bid_factor_of_bids_mean = 50  # Defines the maximal bid for campaigns as a factor of the distribution's mean
...
traffic_mean_cos_wave = DailyCosineWave(dc=3000, amplitude=0.6, phase=0.5)
