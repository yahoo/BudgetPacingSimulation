...
class TestCampaigns(unittest.TestCase):
    ...
    def test_campaign(self):
        ...
        self.assertEqual(campaign.stats.auctions_won[0][0], 1, "expected win counter to be 1")
        self.assertEqual(campaign.stats.spend_history[0][0], bid.amount, "expected spend history to show payment")
